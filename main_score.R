...
#————————————————————————————————————————————————————————————————————————————————————————————————————
# 假设 `blast_df` 是 BLAST 输出的 DataFrame, `mrna_seq` 是包含 mRNA 序列的函数, `all_prf_data` 是包含 PRF 数据的 DataFrame
...
evaluate_scores(df, "total_score")
evaluate_scores(df, "homology_score")
evaluate_scores(df, "distance_score")
evaluate_scores(df, "Alignment_Score")
